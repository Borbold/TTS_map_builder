...
public class VoxelTilePlacerWfcEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if(!VTPW) {
            VTPW = GameObject.FindGameObjectWithTag("VoxelTilePlacerWfc").GetComponent<VoxelTilePlacerWfc>();
        }
...
public class VoxelTilePlacerWfc : MonoBehaviour
{
    ...
    private void PlaceTile(int x, int y)
    {
        ...
        spawnedTiles[x, y] = Instantiate(selectedTile, position, selectedTile.transform.rotation, ParentObject);
    }
